...
export const APP_SCREENSHOTS: AppScreenshot[] = [
  {
    ...
    caption: 'Official Baytul Ilm AI v1.4.1 Android home screen featuring Islamabad prayer times, search bar, and Dars-e-Nizami syllabus highlights.',
    captionUrdu: 'بیت العلم AI ورژن 1.4.1 ہوم اسکرین، اسلام آباد کے اوقاتِ نماز، تیز رفتار سرچ بار اور نصاب کی جھلکیاں۔',
    captionPashto: 'د بیت العلم AI نسخه 1.4.1 اصلي سکرین، د لمانځه کره وختونه او د درسِ نظامي نصاب نښې.',
    category: 'Home',
    imageUrl: homeImg
  },
  {
