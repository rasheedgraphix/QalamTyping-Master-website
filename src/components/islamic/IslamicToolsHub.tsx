            ...
            <div className="space-y-8 animate-fade-in">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-6">
                ...
                <div className="flex flex-wrap items-center gap-1.5">
                  {[
                    { id: 'all', label: 'تمام دعائیں', psLabel: 'ټولې دعاګانې', enLabel: 'All Duas' },
                    { id: 'morning_evening', label: 'صبح و شام', psLabel: 'د سهار او ماښام', enLabel: 'Morning & Evening' },
                    { id: 'daily', label: 'روزمرہ معمولات', psLabel: 'ورځني معمولات', enLabel: 'Daily Routine' },
                    { id: 'travel', label: 'سفر کی دعائیں', psLabel: 'د سفر دعاګانې', enLabel: 'Travel' },
                    { id: 'protection', label: 'حفاظت و عافیت', psLabel: 'ساتنه او حفاظت', enLabel: 'Protection' }
                  ].map((cat) => (
                    <button
                      key={cat.id}
                    ...
                    >
                      {language === 'ps' ? cat.psLabel : language === 'ur' ? cat.label : cat.enLabel}
                    </button>
                  ))}
                </div>
              </div>
          ...
          <div className="mt-10 pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 bg-emerald-50/60 dark:bg-emerald-950/40 p-6 rounded-2xl border border-emerald-200/80 dark:border-emerald-800/80">
            <div className="space-y-1 text-center sm:text-left">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-300 font-urdu">
                {language === 'ur'
                  ? 'بیت العلم AI ورژن 1.4.1 ڈاؤن لوڈ کریں اور تمام اسلامی خصوصیات، مکمل قرآن مجید، درسِ نظامی کی کتب اور دینی کوئز انٹرنیٹ کے بغیر استعمال کریں۔'
                  : language === 'ps'
                  ? 'د بیت العلم AI نسخه 1.4.1 ډاونلوډ کړئ او ټول اسلامي اوزار، بشپړ قرآن کریم، د درسِ نظامي کتابونه او دیني کوئز بې له انټرنیټه وکاروئ.'
                  : 'Download Baytul Ilm AI v1.4.1 to access all Islamic tools, full Quran recitations, Dars-e-Nizami books, and chapter quizzes completely offline.'}
              </p>
            </div>
