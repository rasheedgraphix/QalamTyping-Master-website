...
export const TRANSLATIONS: TranslationDictionary = {
  ...
  downloadPortalSubtitle: {
    en: 'Get the official release package (v1.4.1) directly for your Android smartphone.',
    ur: 'اپنے اینڈرائیڈ فون کے لیے آفیشل تازہ ترین ورژن 1.4.1 براہِ راست حاصل کریں۔',
    ps: 'د خپل انډرایډ موبایل لپاره نوې رسمي نسخه (۱.۴.۱) په مستقیم ډول ترلاسه کړئ.',
  },
  directDownloadNote: {
    en: 'Clicking the button will download the official Version 1.4.1 APK file directly.',
    ur: 'بٹن پر کلک کرنے سے براہِ راست ورژن 1.4.1 کی اصل APK فائل ڈاؤن لوڈ ہوگی۔',
    ps: 'په تڼۍ کلیک کولو سره به د ۱.۴.۱ نسخې اصلي APK فایل په مستقیم ډول ډاونلوډ شي.',
  },
  packageInfo: {
  ...
  installStep1Desc: {
    en: 'Tap on the "Download Latest APK" button to save the Baytul.Ilm.AI.4.apk (v1.4.1) file to your phone.',
    ur: 'ویب سائٹ کے "تازہ ترین APK ڈاؤن لوڈ کریں" بٹن پر کلک کر کے ورژن 1.4.1 کی فائل اپنے فون میں محفوظ کریں۔',
    ps: 'د "Download Latest APK" تڼۍ کېکاږئ ترڅو د v1.4.1 فایل ستاسو په مبایل کې خوندي شي.',
  },
  installStep2Title: {
